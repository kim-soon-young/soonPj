  ...
  $(function(){
    ...
    if ($(settings.datesDiv).length > 0 && $(settings.issuesDiv).length > 0) {
      ...
      $(settings.datesDiv+' a').click(function(event){
        ...
        $(settings.issuesDiv+' li').animate({'opacity':settings.issuesTransparency},{queue:false, duration:settings.issuesTransparencySpeed}).removeClass(settings.issuesSelectedClass).eq(currentIndex).addClass(settings.issuesSelectedClass).fadeTo(settings.issuesTransparencySpeed,1);
